...
public class DriveSample {
  ...
  private static final String UPLOAD_FILE_PATH =
      "/Users/adriansalas/Downloads/1.jpg";
  private static final String DIR_FOR_DOWNLOADS =
      "/Users/adriansalas/Downloads";
  ...
  private static Credential authorize() throws Exception {
    ...
    GoogleClientSecrets clientSecrets =
        GoogleClientSecrets.load(JSON_FACTORY,
            new InputStreamReader(DriveSample.class.getResourceAsStream("/drive/resources/client_secrets.json")));
